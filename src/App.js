...
import matches from "./horrorcards.json";
import "./App.css";

let correctGuesses = 0;
let bestScore = 0;
let clickMessage = "Click on a horror movie to gain points! Click on the same one twice and you lose!";
...
class App extends Component {
    ...
    render() {
        return (
            <Wrapper>
                <Title>Horror Movie Clicks</Title>
